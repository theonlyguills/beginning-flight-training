%
% The RFC Brand New Student Handout.
%
% Don't worry it's super simple. :)

% article is the class of document. It just sets nice defaults as far as the look goes.
% we're also defaulting to 12 point and letter paper 
\documentclass[12pt,letterpaper]{article}

% These are just addons we're loading to use some additional feature
\usepackage{graphicx}
\usepackage{wrapfig}
\usepackage{geometry}
\usepackage{fancyhdr}
...
% variables you can change to personalize this document
...
% fancy style adds more defaults like 3 part footers
\pagestyle{fancy}
\fancyhead{}

\lfoot{Beginning your flight training} % left footer text
\cfoot{}
\rfoot{\thepage} % page number in right footer
\renewcommand{\footrulewidth}{2pt} % thickness of footer line

\oddsidemargin=-20pt % Left margin; widened here with a negative value
\textwidth=7in % Text width
\setlength{\parindent}{0ex} % no paragraph indentation on first line
...
% The RFC logo and photo header with white text layered on top
...
% Generates a full table of contents
\tableofcontents
\pagebreak
...
\section{Maps and airspace}
 ...
 \section{Radio calls}
    ...
    \begin{table}[]
    \hspace*{-1cm}
        \renewcommand{\arraystretch}{2.0} % Default value: 1 Adds vertical spacing in table cells 
        \begin{tabular}{| p{0.30\linewidth} |  p{0.20\linewidth} | p{0.07\linewidth} |  p{0.40\linewidth} |} % the width of each column
        \hline
...
\begin{versionhistory}
  \vhEntry{1.2}{2024--08--15}{GL}{Cleaned-up presentation, vertical space in radio calls. added variables and comments for personalization}
